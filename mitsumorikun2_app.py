# app.py （AI見積もりくん２ / Splatoon-like Neon Dark Theme 完全版）
# - GPT系のみ対応（OpenAI）
# - JSON強制 & 質問カテゴリフォールバック
# - 追加要件込みで再生成
# - 追加質問入力時はプレビューを消去
# - 見積生成後、チャット入力欄の直上にヒント文（st.emptyで確実に表示）
# - Splatoon3風：ネオン×インク×丸み UI テーマ（CSS）
...
if st.session_state["chat_history"] is None:
    st.session_state["chat_history"] = [
        ...
        {"role": "assistant", "content": "ようこそ！こちらは「AI見積もりくん２」です。案件の目的や媒体、納期・予算感など、まずはわかる範囲で教えてください。"}
    ]

# =========================
# テーマ（Splatoon-like：ネオン×インク×丸み）
# =========================
st.markdown("""
